...
void sisipkanJadwal() {
    ...
    if (sisipPos <= 1) {
        cout << "\n>> GAGAL: Posisi sisip harus lebih besar dari 1. Untuk posisi 1, gunakan tambah awal.\n";
        return;
    }
...
void tampilkanSemuaJadwal() {
    clearScreen();
    cout << "\n===================================================================\n";
    cout << "               DAFTAR JADWAL PENERBANGAN (DARI DEPAN)              \n";
    cout << "===================================================================\n";
...
int main() {
    ...
    if (my_strlen(nim) < 3) {
        cout << "NIM tidak valid. Program berhenti.\n";
        return 1;
    }
    ...
    do {
        ...
        cout << "| 4. Cari Jadwal (Detail by ID)             |\n";
        cout << "| 5. Hapus Jadwal Paling Awal               |\n";
        cout << "| 6. Hapus Jadwal Paling Akhir              |\n";
        cout << "| 7. Tampilkan Jadwal (dari Depan)          |\n";
        cout << "| 8. Tampilkan Jumlah Jadwal                |\n";
        cout << "| 9. Tampilkan Jadwal (dari Belakang)       |\n"; 
        cout << "| 0. Keluar                                 |\n";
        cout << "+-------------------------------------------+\n";
        cout << "Pilih menu: ";
        cin >> pilihan;
        ...
        switch (pilihan) {
            ...
            case 9: tampilkanJadwalDariBelakang(); break;
